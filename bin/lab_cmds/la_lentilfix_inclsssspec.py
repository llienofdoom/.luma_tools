...
for cur in list_of_frames:
    ...
    #NORMAL
    os.system('oiiotool %s --ch R,G,B,A,variance.R,variance.G,variance.B,denoise_albedo_noice.R,denoise_albedo_noice.G,denoise_albedo_noice.B,specular.R,specular.G,specular.B,specular_variance.R,specular_variance.G,specular_variance.B,sss.R,sss.G,sss.B,sss_variance.R,sss_variance.G,sss_variance.B %s --ch N_noice.R=N.R,N_noice.G=N.G,N_noice.B=N.B,Z.R,Z.G,Z.B --chappend --chnames R,G,B,A,variance.R,variance.G,variance.B,denoise_albedo_noice.R,denoise_albedo_noice.G,denoise_albedo_noice.B,specular.R,specular.G,specular.B,specular_variance.R,specular_variance.G,specular_variance.B,sss.R,sss.G,sss.B,sss_variance.R,sss_variance.G,sss_variance.B,N_noice.R,N_noice.G,N_noice.B,Z.R,Z.G,Z.B, --attrib "arnold/aovs/RGBA/filter" "RGBA" --attrib "arnold/aovs/variance/filter" "variance_filter" --attrib "arnold/aovs/specular_variance/filter" "variance_filter" --attrib "arnold/aovs/sss_variance/filter" "variance_filter" -o %s' % (cur,crypto_path,cp_path))
